...
break
		...
		let { webp2mp4File } = require('./lib/uploader')
            ...
            let { toAudio } = require('./lib/converter')
            let audio = await toAudio(media, 'mp4')
            kagura.sendMessage(m.chat, {document: audio, mimetype: 'audio/mpeg', fileName: `ᴄᴏɴᴠᴇʀᴛ ʙʏ ꜰʀᴢ-ᴅᴇᴠ.mp3`}, { quoted : m })
            }
            break
...
case 'fiturlist': {
 {
                ...
                {title: "MENU 4", rowId: `mn4`, description: `Show Menu Webzone🖥️`},
                {title: "MENU 5", rowId: `mn5`, description: `Show Menu Downloader📥`},
                {title: "MENU 6", rowId: `mn6`, description: `Show Menu Search🔍`},
                {title: "MENU 7", rowId: `mn7`, description: `Show Menu Random⚠️`},
                ...
                {title: "MENU 16", rowId: `mn16`, description: `Show Menu Islamic☪️`},
                {title: "MENU 17", rowId: `mn17`, description: `Show Menu Voice🗣️`}
                ]
                },
                ]
                kagura.sendListMsg(m.chat, `Saya Assisten ${ownername} ini adalah List Menu Bot Whatsapp Simple !!`, `${ownername}`, `Hai ${pushname}👋 *Selamat ${salam}*`, `Click Here`, sections, m)
                }
            }
            break
...
`
                let btn = [{
                        ...
                        kagura.send5ButImg(m.chat, anu, `ᴄʀᴇᴀᴛᴇᴅ ʙʏ ꜰʀᴢ-ᴅᴇᴠ²⁰²²`, global.thumb, btn)
                        } else if (setbot.templateGif) {
                        kagura.send5ButGif(m.chat, anu, `ᴄʀᴇᴀᴛᴇᴅ ʙʏ ꜰʀᴢ-ᴅᴇᴠ²⁰²²`, global.visoka, btn)
                        } else if (setbot.templateVid) {
                        kagura.send5ButVid(m.chat, anu, `ᴄʀᴇᴀᴛᴇᴅ ʙʏ ꜰʀᴢ-ᴅᴇᴠ²⁰²²`, global.visoka, btn)
                        } else if (setbot.templateMsg) {
                        kagura.send5ButMsg(m.chat, anu, `ᴄʀᴇᴀᴛᴇᴅ ʙʏ ꜰʀᴢ-ᴅᴇᴠ²⁰²²`, btn)
                        }
                     }
            break
            default:
